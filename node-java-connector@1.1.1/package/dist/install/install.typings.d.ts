...
export declare const defaultOptions: InstallOptions;
export declare type SupportedOs = 'linux' | 'windows' | 'mac' | 'solaris' | 'aix' | 'alpine-linux';
declare const supportedArchitectures: readonly ["x64", "x86", "x32", "ppc64", "ppc64le", "s390x", "aarch64", "arm", "sparcv9", "riscv64"];
export declare type SupportedArch = typeof supportedArchitectures[number];
export declare const isSupportedArchitecture: (arch: string) => boolean;
export declare type ImageTypes = 'jre' | 'jdk' | 'testimage' | 'debugimage' | 'staticlibs' | 'sources';
export declare type JvmImplementation = 'hotspot' | 'openj9' | 'dragonwell';
export declare type ReleaseTypes = 'ga' | 'ea';
export declare type HeapSize = 'normal' | 'large';
export declare type Vendors = 'adoptopenjdk' | 'openjdk' | 'eclipse' | 'alibaba' | 'ibm';
export {};
